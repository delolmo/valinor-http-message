...
final class ServerRequestSourceTest extends TestCase
{
    ...
    public function testGetIterator(): void
    {
        ...
        // Check query params replace parsed body
